...
MainWindow::MainWindow(QWidget *parent) :
    QMainWindow(parent)
{
    this->setWindowTitle("Turn over Pokemon by ZHANG Chenyu");
...
void MainWindow::on_about_game() {
    QString introduction(
        ...
        + "<p>" + tr("一个练习C++和Qt的小项目，顺便怀念了一下小时候痴迷的神奇宝贝~玩的时候也能锻炼一下短期记忆能力，希望你能喜欢^^")+"</p>"
...
void MainWindow::on_welcome() {
    ...
    QLabel *welcomeText = new QLabel(tr("宠物小精灵小游戏"), window);
    QFont welcomeFont;
    ...
    welcomeText->setGeometry(QRect(QPoint(250, 150),QSize(700, 100)));
